jQuery(function (t) {
    ...
    } var r, s = "bs.navbar-dropdown", n = "." + s, i = ".data-api", o = { SCROLL_DATA_API: "scroll" + n + i, RESIZE_DATA_API: "resize" + n + i, COLLAPSE_SHOW: "show.bs.collapse", COLLAPSE_HIDE: "hide.bs.collapse", DROPDOWN_COLLAPSE: "collapse.bs.nav-dropdown" }, a = { IN: "in", OPENED: "opened", BG_COLOR: "bg-color", DROPDOWN_OPEN: "navbar-dropdown-open", SHORT: "navbar-short" }, h = { BODY: "body", BASE: ".navbar-dropdown", TOGGLER: '.navbar-toggler[aria-expanded="true"]', TRANSPARENT: ".transparent", FIXED_TOP: ".navbar-fixed-top" }
    t(window).on(o.SCROLL_DATA_API + " " + o.RESIZE_DATA_API, function (t) { clearTimeout(r), r = setTimeout(function () { e(t) }, 10) }).trigger(o.SCROLL_DATA_API), t(document).on(o.COLLAPSE_SHOW + " " + o.COLLAPSE_HIDE, function (e) { t(e.target).closest(h.BASE).each(function () { "show" == e.type ? (t(h.BODY).addClass(a.DROPDOWN_OPEN), t(this).addClass(a.OPENED).removeClass(a.SHORT).removeClass(a.BG_COLOR)) : (t(h.BODY).removeClass(a.DROPDOWN_OPEN), t(this).addClass(a.BG_COLOR).removeClass(a.OPENED), t(window).trigger(o.SCROLL_DATA_API)) }) }).on(o.DROPDOWN_COLLAPSE, function (e) { t(e.relatedTarget).closest(h.BASE).find(h.TOGGLER).trigger("click") })
}), function (t) {
    var e = "navDropdown", r = "bs.nav-dropdown", s = "." + r, n = ".data-api", i = t.fn[e], o = { HIDE: "hide" + s, HIDDEN: "hidden" + s, SHOW: "show" + s, SHOWN: "shown" + s, CLICK: "click" + s, READY: "ready" + s, COLLAPSE: "collapse" + s, LOAD_DATA_API: "load" + s + n, CLICK_DATA_API: "click" + s + n, RESIZE_DATA_API: "resize" + s + n, KEYDOWN_DATA_API: "keydown" + s + n }, a = { ESC: 27, LEFT: 37, UP: 38, RIGHT: 39, DOWN: 40 }, h = { XS: 544, SM: 768, MD: 992, LG: 1200, XL: 1 / 0 }, l = { BACKDROP: "dropdown-backdrop", DISABLED: "disabled", OPEN: "open", SM: "nav-dropdown-sm" }, p = { BASE: ".nav-dropdown", DROPDOWN: ".dropdown", DROPDOWN_MENU: ".dropdown-menu", BACKDROP: "." + l.BACKDROP, DATA_BUTTON: "[data-button]", DATA_TOGGLE: '[data-toggle="dropdown-submenu"]', FORM_CHILD: ".dropdown form" }, c = function () {
        function e(e, r) {
            ...
            return new e(t(this).map(function () {
                var r = new e(this)
                return r.is(":upper") ? null : t(r.is(":toggle") ? this.parentNode.parentNode : this).closest(p.DROPDOWN).find(">" + p.DATA_TOGGLE)[0]
            }), this)
        }, e.prototype.parents = function (r) {
            var s = t(this).map(function () { return new e(this).is(":toggle") ? this.parentNode : this }).parentsUntil(p.BASE, p.DROPDOWN)
            return ":upper" === r && (s = s.last()), s = s.find(">" + p.DATA_TOGGLE), new e(s, this)
        }, e.prototype.children = function (r) {
            var s = []
            return t(this).each(function () {
                var n, i, o = new e(this)
                if (o.is(":root")) n = t(this)
                else {
                    if (!o.is(":toggle")) return
                    n = t(this).parent().find(">" + p.DROPDOWN_MENU)
                } i = r ? n.find("a") : o.is(":root") ? n.find(">li>a") : n.find(">a, >" + p.DROPDOWN + ">a"), i.each(function () { r && !this.offsetWidth && !this.offsetHeight || this.disabled || t(this).is(p.DATA_BUTTON) || t(this).hasClass(l.DISABLED) || ~t.inArray(this, s) || s.push(this) })
            }), new e(s, this)
        }, e.prototype.root = function () { return new e(t(this).closest(p.BASE), this) }, e.prototype.jump = function (r) {
            ...
            if ("next" == r) {
                ...
                r = "last"
            } return "first" == r ? new e(s[0], this) : "last" == r ? new e(s[s.length - 1], this) : new e([], this)
            ...
            for (var r = t(this), s = (e || "").split(/(?=[*#.\[:\s])/) ; e = s.pop() ;) switch (e) {
                case ":root": if (!r.is(p.BASE)) return !1
                    break
    ...
    d.prototype.toggle = function (e) {
        ...
        if ("ontouchstart" in document.documentElement && !r.closest(p.DROPDOWN + "." + l.OPEN).length) {
            var i = document.createElement("div")
            i.className = l.BACKDROP, i.style.background = "transparent", t(i).insertBefore(t(this).closest(p.BASE)), t(i).on("click", d._clearMenus)
        } var a = { relatedTarget: this }, h = t.Event(o.SHOW, a)
        return r.trigger(h), h.isDefaultPrevented() ? !1 : (this.focus(), this.setAttribute("aria-expanded", "true"), r.toggleClass(l.OPEN), r.trigger(t.Event(o.SHOWN, a)), !1)
    }, d.prototype.dispose = function () { t.removeData(this._element, r), t(this._element).off(s), this._element = null }, d._clearMenus = function (e) {
        if (e = e || {}, 3 !== e.which) {
            var r
            if (this === document) {
                ...
                else if (d._isCollapsed(s)) return void t(document).trigger(t.Event(o.COLLAPSE, { relatedTarget: s[0] }))
            ...
            } for (var h = e.toggles || t.makeArray(t(p.DATA_TOGGLE).not(i)), c = 0; c < h.length; c++) {
                var u = h[c].parentNode, f = { relatedTarget: h[c] }
                if (t(u).hasClass(l.OPEN) && ("click" !== e.type || !/input|textarea/i.test(e.target.tagName) || !t.contains(u, e.target))) {
                    var A = t.Event(o.HIDE, f)
                    t(u).trigger(A), A.isDefaultPrevented() || (h[c].setAttribute("aria-expanded", "false"), t(u).removeClass(l.OPEN).trigger(t.Event(o.HIDDEN, f)))
                }
        ...
        t(p.BASE).each(function () {
            ...
            r && r.parentNode.removeChild(r), e != t(this).hasClass(l.SM) && (e ? t(this).addClass(l.SM) : t(this).removeClass(l.SM))
        })
    }, t.fn[e] = function (e) {
    ...
    }, t.fn[e].noConflict = function () { return t.fn[e] = i, this }, t.fn[e].Constructor = d, t.fn[e].$$ = c, t(window).on(o.RESIZE_DATA_API + " " + o.LOAD_DATA_API, d._dataApiResizeHandler), t(document).on(o.KEYDOWN_DATA_API, p.BASE, d._dataApiKeydownHandler).on(o.CLICK_DATA_API, d._clearMenus).on(o.CLICK_DATA_API, p.DATA_TOGGLE, d.prototype.toggle).on(o.CLICK_DATA_API, p.FORM_CHILD, function (t) { t.stopPropagation() }), t(window).trigger(o.READY)
}(jQuery)